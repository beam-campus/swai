defmodule Agrex.Schema.ScapeTest do
  use ExUnit.Case

  alias Agrex.Schema.Scape
  ...
  @tag :ignore_test
  test "that the module Agrex.Schema.Scape exists" do
    assert is_list(Agrex.Schema.Scape.module_info())
  end
